...
object PresetLibrary {
    fun getExamples(): List<PresetExample> = listOf(
        PresetExample(
            id = 0,
            label = "Sakura",
            ...
            makePlantConfig = { sentence ->
                PlantConfig(
                    ...
                    leaves = LeafConfig(type = LeafType.TYPE0, length = 10f),
        ...
        PresetExample(
            ...
            makePlantConfig = { sentence ->
                PlantConfig(
                    lSystemSentence = sentence,
                    leaves = LeafConfig(type = LeafType.TYPE1, length = 8f),
                    branches = BranchConfig(
                        baseLength = 12f,
                        baseAngle = 25f,
                        baseWidth = 30f,
        ...
        PresetExample(
            ...
            makePlantConfig = { sentence ->
                PlantConfig(
                    lSystemSentence = sentence,
                    leaves = LeafConfig(type = LeafType.TYPE2, length = 12f),
                    branches = BranchConfig(
                        baseLength = 20f,
                        baseAngle = 30f,
                        baseWidth = 40f,
        ...
        PresetExample(
            ...
            makePlantConfig = { sentence ->
                PlantConfig(
                    lSystemSentence = sentence,
                    leaves = LeafConfig(type = LeafType.TYPE0, length = 6f),
                    branches = BranchConfig(
                        baseLength = 10f,
                        baseAngle = 22f,
                        baseWidth = 25f,
